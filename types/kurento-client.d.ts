  ...
  declare namespace kurento {
    ...
    interface UriEndpoint extends Endpoint {
      ...
      on(
        ...
        callback: (
          event: Event<"UriEndpointStateChanged", { state: UriEndpointState }>,
        ) => void,
      ): UriEndpoint;
    ...
    interface PlayerEndpoint extends UriEndpoint {
      ...
      setPosition(position: number, callback?: () => void): Promise<void>;
      getPosition(callback?: (position: number) => void): Promise<number>;
      getVideoInfo(callback?: (info: VideoInfo) => void): Promise<VideoInfo>;
